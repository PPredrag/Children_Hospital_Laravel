...
<div class="col-md-10 col-md-offset-1">
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" rows="4"  id="simptomi" name="simptomi" ></textarea>
  </div>
  <div class="form-group">
    <label for="comment">Dijagnoza</label>
    <textarea class="form-control" rows="4" id="comment" name="dijagnoza" >{{ Session::get('vreme') }}</textarea>
  </div>
  <div class="form-group">
    <label for="comment">Lecenje</label>
    <textarea class="form-control" rows="4" id="comment" name="lecenje" >{{Session::get('vreme')}}</textarea>
  </div>
  <div class="form-group">
    <label for="lek">Medikamenti</label>
    <textarea class="form-control" rows="4" id="lek" name="lek" >{{Session::get('vreme')}}</textarea>
  </div>
</div>
@endsection