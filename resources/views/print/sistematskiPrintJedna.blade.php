...
<div class="form-group" id="">
  ...
  <textarea class="form-control" rows="3"  id="unos" name="opis">{{ Session::get('krv')}}</textarea>
</div>
<div class="form-group" id="">
  <label for="krv">Izvestaj Snimanja Kukova:</label>
  <textarea class="form-control" rows="3"  id="daa" name="kukovi">{{ Session::get('kukovi')}}</textarea>
</div>
<div class="form-group" id="">
