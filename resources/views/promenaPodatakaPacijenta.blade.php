        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <p class="zeleno" id="sakri">{{session('success')}}</strong>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><strong>Promena Podataka Pacijenta</strong></div>
                    <div class="panel-body">
                        
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('upisiPromenuPacijenta/'.$data->id)}}">
                            {{ csrf_field() }}
