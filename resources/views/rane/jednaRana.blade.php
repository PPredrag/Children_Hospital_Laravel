...
<div class="container">
  <div class="row">
    <h3 class="inline"><p class="naslov">Prikaz Previjanja</p></h3>
    <table class="table">
      <tbody>
        <tr>
          <td>
  ...
  <div class="col-md-10 col-md-offset-1">
    ...
    <label for="potvrda">Deo Tela</label>
    <textarea name="potvrda" class="form-control" id="potvrda" cols="10" rows="5">{{$da->deoTela}}</textarea><br><br>
    <label for="potvrda">Opis Povrede</label>
    <textarea name="potvrda" class="form-control" id="potvrda" cols="10" rows="5">{{$da->povreda}}</textarea><br><br>
    <label for="potvrda">Terapija</label>
    <textarea name="potvrda" class="form-control" id="potvrda" cols="10" rows="5">{{$da->terapija}}</textarea><br><br>
    @endforeach
    <div class="dugmeStampa"><a href="{{ url('printSpisakRana') }}" class="stampa"> Štampa</a></div>
  </div>
</div>
@endsection
@section('footer')
